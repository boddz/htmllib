...
if __name__ == "__main__":
    ...
    HTMLCODE = "<html id='123' lang='en'> <div lang = 'en'    class ='123'> <p id='123'> </p></html>"
    ...
    print(htmltree.search_opening_tags_by_name("style"))
    # print(htmltree.search_opening_tags_by_attrs({"lang": "en", "id": "123"}))
    # print(htmltree.search_opening_tags_by_exact_attrs({"id": "123", "lang": "en"}))
    # print(htmltree.search_opening_tags_by_attr(("type", "text/css")))
    # print(htmltree.search_opening_tags_by_id("123"))
    # print(htmltree.search_opening_tags_by_class("123"))
